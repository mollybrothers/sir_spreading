...
# PLOT CONTROL REGION
plot_loess(methyl_filtered_wt, methyl_filtered_D, methyl_filtered_bah, "III", 80e3, 105e3)
# with genes:
...
# PLOT HML
plot_loess(methyl_filtered_wt, methyl_filtered_D, methyl_filtered_bah, "III", 0, 25e3)
# with genes:
...
# PLOT HMR
plot_loess(methyl_filtered_wt, methyl_filtered_D, methyl_filtered_bah, "III", 280e3, 305e3)
# with genes:
...
for (i in 1:16){
  plot_loess(methyl_filtered_wt, methyl_filtered_D, methyl_filtered_bah, chromosomes[i], 0, 15e3)
}
for (i in 1:16){
  plot_loess(methyl_filtered_wt, methyl_filtered_D, methyl_filtered_bah, chromosomes[i], right_ends[i]-15e3, right_ends[i])
}
```
