...
methyl_ev <- fread("/home/mbrothers/nanopore/211022_Bonus/modified_bases.aggregate03.6mA.bed",
                col.names = columns)
methyl_filtered_ev <- methyl_ev[coverage > 10, ..select_cols]

# SIR3-ecoGII overexpression
methyl_oe <- fread("/home/mbrothers/nanopore/211022_Bonus/modified_bases.aggregate04.6mA.bed",
                col.names = columns)
methyl_filtered_oe <- methyl_oe[coverage > 10, ..select_cols]

# PLOT CONTROL REGION
plot_loess(methyl_filtered_ev, methyl_filtered_oe, "III", 80e3, 105e3)
# with genes:
...
# PLOT HML
plot_loess(methyl_filtered_ev, methyl_filtered_oe, "III", 0, 25e3)
# with genes:
...
# PLOT HMR
plot_loess(methyl_filtered_ev, methyl_filtered_oe, "III", 280e3, 305e3)
# with genes:
...
for(i in 1:16){
  plot_loess(methyl_filtered_ev, methyl_filtered_oe, chromosomes[i], 0, 15e3)
}

for(i in 1:16){
  plot_loess(methyl_filtered_ev, methyl_filtered_oe, chromosomes[i], right_ends[i]-15e3, right_ends[i])
}
```
