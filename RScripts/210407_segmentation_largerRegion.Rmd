---
title: "Segmentation analysis on steady-state: larger region"
...
meth6_HMR <- filtered_meth6[filtered_meth6$chrom == "III" &
                            filtered_meth6$start >= (min(hmrE) - 500) &
                            filtered_meth6$start <= (max(hmrI) + 500),]
...
meth7_HMR <- filtered_meth7[filtered_meth7$chrom == "III" &
                            filtered_meth7$start >= (min(hmrE) - 500) &
                            filtered_meth7$start <= (max(hmrI) + 500),]
...
saveRDS(segments, file="../data/segmentsHMR_extended.rds")
```
...
meth6_HML <- filtered_meth6[filtered_meth6$chrom == "III" &
                            filtered_meth6$start >= (min(hmlE) - 500) &
                            filtered_meth6$start <= (max(hmlI) + 500),]
...
meth7_HML <- filtered_meth7[filtered_meth7$chrom == "III" &
                            filtered_meth7$start >= (min(hmlE) - 500) &
                            filtered_meth7$start <= (max(hmlI) + 500),]
...
saveRDS(segments, file="../data/segmentsHML_extended.rds")
```