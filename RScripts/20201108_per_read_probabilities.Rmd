...
date: 2020-11-08
title: "Per-read Probabilities"
output: html_document
---

**this is only using a small subset of the total reads**
...
## separate positive and negative stranded reads
```{r message = FALSE}
#separate positive and negative stranded reads
...
## plot some regions, using the average mod_log_prob for each adenine
```{r message = FALSE}
#plot regions with average mod_log_probs
