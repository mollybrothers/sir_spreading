...
methyl_0 <- fread("/home/mbrothers/nanopore/210706_Fireworks/megalodon_output_09/modified_bases.aggregate09.6mA.bed",
                col.names = columns)
methyl_filtered_0 <- methyl_0[coverage > 10, ..select_cols]

methyl_30 <- fread("/home/mbrothers/nanopore/210706_Fireworks/megalodon_output_10/modified_bases.aggregate10.6mA.bed",
                  col.names = columns)
methyl_filtered_30 <- methyl_30[coverage > 10, ..select_cols]

methyl_60 <- fread("/home/mbrothers/nanopore/210706_Fireworks/megalodon_output_11/modified_bases.aggregate11.6mA.bed",
                  col.names = columns)
methyl_filtered_60 <- methyl_60[coverage > 10, ..select_cols]

methyl_90 <- fread("/home/mbrothers/nanopore/210706_Fireworks/megalodon_output_12/modified_bases.aggregate12.6mA.bed",
                  col.names = columns)
methyl_filtered_90 <- methyl_90[coverage > 10, ..select_cols]

# methyl_120 <- fread("/home/mbrothers/nanopore/210607_Dotty/modified_bases.aggregate11.6mA.bed",
#                    col.names = columns)
# methyl_filtered_120 <- methyl_120[coverage > 10, ..select_cols]
# 
# methyl_150 <- fread("/home/mbrothers/nanopore/210607_Dotty/modified_bases.aggregate12.6mA.bed",
#                     col.names = columns)
...
# for HMR
chromo <- "III"
beg <- 292674 - 7000 #285e3 #
end <- 294864 + 7000 #305e3 #
...
legend("topleft", legend = c("SIR3-EcoGII", "sir3∆::EcoGII", "sir3-bah∆-EcoGII", "sir3-wH∆-EcoGII"), fill = my_pal)
